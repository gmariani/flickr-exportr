...
if ( !class_exists('phpFlickr') ) {
	...
	class phpFlickr {
		...
		function __construct($api_key, $secret = NULL, $die_on_error = false) {
			$this->phpFlickr2($api_key, $secret, $die_on_error);
		}

		function phpFlickr2 ($api_key, $secret = NULL, $die_on_error = false) {
...
if ( !class_exists('phpFlickr_pager') ) {
	class phpFlickr_pager {
		...
		function __construct($api_key, $secret = NULL, $die_on_error = false) {
			$this->phpFlickr_pager2($phpFlickr, $method, $args, $per_page);
		}
		
		function phpFlickr_pager2($phpFlickr, $method = null, $args = null, $per_page = 30) {
